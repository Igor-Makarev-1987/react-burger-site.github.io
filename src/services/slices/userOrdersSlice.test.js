...
import { wsConnectingUser, wsCloseUser, wsErrorUser, wsOpenUser, wsMessageUser, initialState } from "./userOrdersSlice";
...
it("should return state and fill received answer from ws when it has message", () => {
    ...
    expect(userOrdersSlice(initialState, wsMessageUser(mockedData))).toEqual(expectedState)
} )
});